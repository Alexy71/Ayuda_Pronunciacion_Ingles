...
"""distancia entre palabras estimadas y palabras reales"""
def get_word_distance_matrix(words_estimated: list, words_real: list) -> np.array:
    ...
    #recorremos entre cada palabra estimada y reales
    ...
    #agregamos la info add a la matriz, long de cada palabra en la ultima fila de la matriz
    if offset_blank == 1:
        for idx_real in range(number_of_real_words):
...
"""calcula la mejor ruta mediante la matriz de distancia"""
def get_best_path_from_distance_matrix(word_distance_matrix):
    modelCpp = cp_model.CpModel()

    #nro de palabras reales y palabras estimadas en base a la matriz
    ...
    # verificamos que el orden de las palabras sea ascendente
    ...
    #si no se encuentra una coincidencia, multiplicando la distancia de fonemas correspondiente por la negación de word_has_a_match
    real_word_at_time = {}
    for idx_estimated in range(number_of_estimated_words):
        for idx_real in range(number_of_real_words):
            ...
            #almacenamos la distancia ponderada de fonemas
    ...
    for idx_real in range(number_of_real_words):
        ...
        #verifiar si la palabra real coincide con la estimada
...
"""genera una lista de palabras mapeadas con palabras estimadas y reales"""
...
"""calcula mejores palbras mapeadas entre estimadas y reales"""
...
"""mejores usando Dinamic time warping"""
...
"""det que letras de una palabra se transcribieron correctamente comparando"""
