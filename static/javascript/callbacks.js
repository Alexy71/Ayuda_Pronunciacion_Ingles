...
const page_title = "pronunciacion en ingles";
...
const UIError = () => {
    ...
    document.getElementById("main_title").innerHTML = 'Error';
    document.getElementById("original_script").innerHTML = 'Presentas un error en el codigo';
};

const UINotSupported = () => {
    unblockUI();

    document.getElementById("main_title").innerHTML = "error del navegador";

}

const UIRecordingError = () => {
    unblockUI();
    document.getElementById("main_title").innerHTML = "error en el audio";
    startMediaDevice();
}
    ...
    try {
        await fetch(apiMainPathSample + '/getSample', {
            ...
            then(data => {
                ...
                document.getElementById("single_word_ipa_pair").innerHTML = "Pronunciacion"
                document.getElementById("section_accuracy").innerHTML = "| puntuacion " + currentScore.toString() + " - (" + currentSample.toString() + ")";
                currentSample += 1;
...
//actualizamos el estado de grabacion
...
const recordSample = async () => {
    ...
    document.getElementById("main_title").innerHTML = "Grabando... haz clic de nuevo cuando termines de hablar";
...
const changeLanguage = (language, generateNewSample = false) => {
    ...
    //verificamos si voces e idioma coincide
    ...
    // vemos si alguna voz tiene coincidencia 
    if (!languageFound) {
        for (idx = 0; idx < voices.length; idx++) {
