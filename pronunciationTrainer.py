...
class PronunciationTrainer:
    ...
    #ue recibe la longitud del audio en muestras y devuelve el transcripto del audio y las ubicaciones de las palabras.
    def getTranscriptAndWordsLocations(self, audio_length_in_samples: int):
        #obtener el el transcripto usado de ASR
        ...
        #ajustamos para un marjen de duracion de muestras
        ...
        #transcripto del audio y las ubicaciones de las palabras.
        return audio_transcript, word_locations_in_samples
    
    #recibe el audio grabado y las ubicaciones de las palabras, y devuelve las entonaciones relativas de las palabras.
    def getWordsRelativeIntonation(self, Audio: torch.tensor, word_locations: list):
        ...
        #calcula la entonacion para cada palabra
    ...
    ##################### ASR Functions ###########################
    #procesa el audio grabado en función de un texto
    ...
    #convierte las ubicaciones de las palabras en muestras a ubicaciones en segundos
    ...
    #mapeo entre las palabras del texto real y las palabras transcritas
    ...
    #precisión de pronunciación en base a las palabras reales y las palabras mapeadas
